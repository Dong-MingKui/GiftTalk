...
import com.dongkui.gifttalk.utils.minterface.Pullable;
...
//        Animation animation = AnimationUtils.loadAnimation(context , R.anim.pulltorefresh);
//        refreshingView.startAnimation(animation);
